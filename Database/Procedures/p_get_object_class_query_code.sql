DROP PROCEDURE IF EXISTS [config].[p_get_object_class_query_code];
GO

CREATE PROCEDURE [config].[p_get_object_class_query_code]
(
...
EXEC [config].[p_get_object_class_query_code] 
